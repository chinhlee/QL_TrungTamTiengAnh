...
{
    public partial class ThongKeHocVien : Form
    {
        ...
        private void bt_thongke_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string sql_search = "select HocVien.maHV,HoTen,NgaySinh,GioiTinh,DiaChi,Email,SDT from HocVien,LopHoc,KhoaHoc where HocVien.maLH=LopHoc.maLH and LopHoc.maKH=KhoaHoc.maKH and TenKH='" + khoahoc.Text + "'";
