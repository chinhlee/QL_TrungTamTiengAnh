...
{
    public partial class ThongKeGV : Form
    {
        ...
        private void bt_thongke_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string sql_search = "select GiangVien.maGV,HoTen,NgaySinh,GioiTinh,DiaChi,Email,SDT\r\nfrom GiangVien,LopHoc where GiangVien.maGV=LopHoc.maGV and maLH='" + lophoc.Text + "'";
